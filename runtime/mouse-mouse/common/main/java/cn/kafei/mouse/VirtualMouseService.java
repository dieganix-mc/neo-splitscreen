...
public final class VirtualMouseService {
    ...
    public static void refreshForCurrentScreen(Minecraft mc) {
        if (!InputIsolationService.shouldUseVirtualScreenInput(mc) || mc.gui.screen() == null) {
    ...
    public static boolean shouldRenderOverlay(Minecraft mc) {
        return mc != null && initialized && InputIsolationService.shouldRenderVirtualCursor(mc.gui.screen());
    }
