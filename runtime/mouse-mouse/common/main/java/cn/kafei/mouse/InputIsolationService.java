...
public final class InputIsolationService {
    ...
    public static RoutedInputMode getRoutedInputMode(Minecraft mc) {
        if (!isolationEnabled || mc == null || mc.gui.overlay() != null) {
            return RoutedInputMode.DISABLED;
        }
        if (mc.gui.screen() != null && !(mc.gui.screen() instanceof DeviceSelectScreen)) {
    ...
    private static boolean isIsolationTarget(Minecraft mc, long windowPointer) {
        ...
        if (mc == null || mc.getWindow().handle() != windowPointer) return false;
        if (mc.gui.overlay() != null || mc.gui.screen() instanceof DeviceSelectScreen) return false;
